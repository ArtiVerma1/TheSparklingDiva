...
import com.kumaoni.blessings.databinding.MProductviewBinding
import com.kumaoni.blessings.databinding.ReviewFormBinding
import com.kumaoni.blessings.databinding.SizeChartLayoutBinding
import com.kumaoni.blessings.databinding.SwatchesListBinding
import com.kumaoni.blessings.personalised.adapters.PersonalisedAdapter
import com.kumaoni.blessings.personalised.viewmodels.PersonalisedViewModel
import com.kumaoni.blessings.productsection.adapters.ImagSlider
import com.kumaoni.blessings.productsection.adapters.ReviewListAdapter
import com.kumaoni.blessings.productsection.adapters.VariantAdapter
import com.kumaoni.blessings.productsection.models.Review
import com.kumaoni.blessings.productsection.models.ReviewModel
import com.kumaoni.blessings.productsection.viewmodels.ProductViewModel
import com.kumaoni.blessings.utils.*
...
class ProductView : NewBaseActivity() {
    ...
    private fun setProductData(productedge: Storefront.Product?) {
        ...
        try {
            ...
            var head1 = "<head><style>@font-face {font-family: 'arial';src: url('file:///android_asset/fonts/mangosansregular.ttf');}body {font-family: 'verdana';color: #000000}</style></head>"
            var text = "<html>" + head1 + "<body style='font-family: arial'>" + productedge.descriptionHtml + "</body></html>"

            binding?.description?.loadDataWithBaseURL("", text, "text/html", "utf-8", "")
