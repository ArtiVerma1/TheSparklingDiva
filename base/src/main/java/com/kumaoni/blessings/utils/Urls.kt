...
class Urls {
    ...
    val shopdomain: String
        get() {
            var domain = "kumaoni-blessings.myshopify.com" //magenative-store.myshopify.com
            try {
    ...
    val apikey: String
        get() {
            var key = "ce2389e81eec60184769ff18675d79aa" //63893d2330e639632e2eab540e9d2d75
            try {
                val executor = Executors.newSingleThreadExecutor()
                val callable = Callable {
                    if (repository.getPreviewData().size > 0) {
