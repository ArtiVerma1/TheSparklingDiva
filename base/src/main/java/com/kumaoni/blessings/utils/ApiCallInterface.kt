...
import com.kumaoni.blessings.utils.Urls.Data.JUDGEME_GETPRODUCTID
import com.kumaoni.blessings.utils.Urls.Data.JUDGEME_REVIEWCOUNT
import com.kumaoni.blessings.utils.Urls.Data.JUDGEME_REVIEWCREATE
import com.kumaoni.blessings.utils.Urls.Data.JUDGEME_REVIEWINDEX
import com.kumaoni.blessings.utils.Urls.Data.SIZECHART
...
interface ApiCallInterface {
    ...
    fun getRecommendations(@Header("X-SHOP") shop: String, @Header("X-CLIENT") client: String, @Header("X-ACCESS-TOKEN") token: String, @Header("Content-Type") content_tyepe: String, @Body body: com.kumaoni.blessings.dependecyinjection.Body): Single<JsonElement>
