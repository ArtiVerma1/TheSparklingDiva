...
public class MSlideritemoneBindingImpl extends MSlideritemoneBinding implements com.kumaoni.blessings.generated.callback.OnClickListener.Listener {
    ...
    public MSlideritemoneBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private MSlideritemoneBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback56 = new com.kumaoni.blessings.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.commondata == variableId) {
            ...
            setClickproduct((com.kumaoni.blessings.homesection.adapters.ProductSliderAdapter.Product) variable);
        }
    ...
    public void setClickproduct(@Nullable com.kumaoni.blessings.homesection.adapters.ProductSliderAdapter.Product Clickproduct) {
    ...
    protected void executeBindings() {
        ...
        com.kumaoni.blessings.homesection.adapters.ProductSliderAdapter.Product clickproduct = mClickproduct;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
            ...
            this.main.setOnClickListener(mCallback56);
        }
        if ((dirtyFlags & 0x12L) != 0) {
            // api target 1
