...
public final class WishListAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.kumaoni.blessings.wishlistsection.viewholders.WishItem> {
    private java.util.List<com.kumaoni.blessings.dbconnection.entities.ItemData> data;
    private android.view.LayoutInflater layoutInflater;
    private com.kumaoni.blessings.wishlistsection.viewmodels.WishListViewModel model;
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public com.kumaoni.blessings.wishlistsection.viewholders.WishItem onCreateViewHolder(@org.jetbrains.annotations.NotNull()
    ...
    com.kumaoni.blessings.wishlistsection.viewholders.WishItem holder, int position) {
    }
    ...
    java.util.List<com.kumaoni.blessings.dbconnection.entities.ItemData> data, @org.jetbrains.annotations.NotNull()
    com.kumaoni.blessings.wishlistsection.viewmodels.WishListViewModel model) {
    }
    ...
    public final class ClickHandlers {
        ...
        com.kumaoni.blessings.wishlistsection.models.WishListItem item) {
        }
