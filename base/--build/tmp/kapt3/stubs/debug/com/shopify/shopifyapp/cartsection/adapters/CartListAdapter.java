package com.kumaoni.blessings.cartsection.adapters;
...
public final class CartListAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.kumaoni.blessings.cartsection.viewholders.CartItem> {
    @org.jetbrains.annotations.Nullable()
    private java.util.List<com.shopify.buy3.Storefront.CheckoutLineItemEdge> data;
    private android.view.LayoutInflater layoutInflater;
    private com.kumaoni.blessings.cartsection.viewmodels.CartListViewModel model;
    ...
    @java.lang.Override()
    public com.kumaoni.blessings.cartsection.viewholders.CartItem onCreateViewHolder(@org.jetbrains.annotations.NotNull()
    ...
    com.kumaoni.blessings.cartsection.viewholders.CartItem holder, int position) {
    }
    
    private final void setVariants(com.kumaoni.blessings.cartsection.models.CartListItem item, com.kumaoni.blessings.cartsection.viewholders.CartItem holder, java.util.List<? extends com.shopify.buy3.Storefront.SelectedOption> selectedOptions) {
    }
    ...
    com.kumaoni.blessings.cartsection.viewmodels.CartListViewModel model) {
    }
